...
<head>
  ...
  <title>Property Hunter Realty | Property Locations</title>
...
<br>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#newpropertyloc" style="font-family: 'Segoe UI', sans-serif; font-size: 1.5rem; margin-left: 89rem; width: 17rem;"><span class="glyphicon glyphicon-plus-sign"></span> Add Location</button>
              </div>
...
<?php include('includes/newpropertyloc.php');?>
