...
<head>
  ...
  <title>Property Hunter Realty | Commissions</title>
...
<br>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#newcommission" style="font-family: 'Segoe UI', sans-serif; font-size: 1.5rem; margin-left: 89rem; width: 17rem;"><span class="glyphicon glyphicon-plus-sign"></span> Add Commission</button>
...
<?php include('includes/newcommission.php');?>
