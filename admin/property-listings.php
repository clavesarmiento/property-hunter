...
$sql = "DELETE from properties  WHERE  id=:delid";
...
$price=$_POST['price'];
$prop_loc=$_POST['property_loc'];
$prop_img=$_FILES['prop_img'];
...
move_uploaded_file($_FILES["prop_img"]["tmp_name"],"img/propertyimages/".$_FILES["prop_img"]["name"]);


$sql = "INSERT INTO properties(property_id,propertytype.property_type=propertytype_id,price,location.location_name=location_id,property_img,property_bathroom,property_bedroom,property_garage,lot_area,floor_area) VALUES(:prop_id,:prop_type,:price,:prop_loc,:prop_img,:bath,:bed,:garage,:lotarea,:floorarea)";

$query = $dbh->prepare($sql);
$query->bindParam(':prop_id',$prop_id,PDO::PARAM_STR);
$query->bindParam(':prop_type',$prop_type,PDO::PARAM_STR);
$query->bindParam(':price',$price,PDO::PARAM_STR);
$query->bindParam(':prop_loc',$prop_loc,PDO::PARAM_STR);
$query->bindParam(':prop_img',$prop_img,PDO::PARAM_STR);
...
$query->bindParam(':lotarea',$lotarea,PDO::PARAM_STR);
$query->bindParam(':floorarea',$floorarea,PDO::PARAM_STR);
...
<head>
  ...
  <title>Property Hunter Realty | Property Listings</title>
...
<br>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#newproperty" style="font-family: 'Segoe UI', sans-serif; font-size: 1.5rem; margin-left: 89rem; width: 17rem;"><span class="glyphicon glyphicon-plus-sign"></span> Add Property</button>
              </div>
...
<?php include('includes/newproperty.php');?>
